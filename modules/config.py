class Config:
    ...
    MAIL_USERNAME = 'tripindia.iitj@gmail.com'
    MAIL_PASSWORD = 'msdy dojh xmye rkya'
    MAIL_PORT = 465
    MAIL_USE_SSL = True
    MAIL_USE_TSL = False
    MAIL_DEFAULT_SENDER = "tripindia.iitj@gmail.com"

    ADMIN_ADDRESS = "deshmukh.1@iitj.ac.in"
